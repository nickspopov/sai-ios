...
public class GetCommunityQuery: GraphQLQuery {
  public static let operationName: String = "GetCommunity"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetCommunity($id: String!) { getCommunity(id: $id) { __typename id name owner { __typename id name } places { __typename id name lat lon } members { __typename user { __typename id name } lastCheckin { __typename date place { __typename id name } } } } }"#
    ))
  ...
  public struct Data: SaiFastAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("getCommunity", GetCommunity.self, arguments: ["id": .variable("id")]),
    ] }

    public var getCommunity: GetCommunity { __data["getCommunity"] }
